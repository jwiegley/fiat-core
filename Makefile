...
.PHONY: fiat fiat-core finitesets compiler facade-test ics fiat4monitors \
	fiat-quick fiat-core-quick finitesets-quick compiler-quick facade-test-quick ics-quick fiat4monitors-quick \
	install install-fiat install-fiat-core install-finitesets install-compiler install-ics install-fiat4monitors \
	pdf doc clean-doc \
...
install-fiat install-fiat-core install-finitesets install-compiler:
